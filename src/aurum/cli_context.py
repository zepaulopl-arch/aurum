...
from aurum.market_context_auto import calibrate_market_context_thresholds
from aurum.market_context_consolidator import load_market_context_config
from aurum.manifest import write_json
from aurum.market_context_sources import (
...
def _refresh_context_sources(args: Any) -> dict[str, Any]:
    ...
    if source_data:
        from aurum.market_context_sources import merge_source_data
...
def run_context_command(args: Any) -> int:
    if args.context_command == "auto":
        ...
        if getattr(args, "json", False):
            ...
            print("AURUM MARKET CONTEXT AUTO")
            print("-" * 100)
    ...
    if args.context_command == "calibrate":
        ...
        if getattr(args, "json", False):
            ...
            print("AURUM MARKET CONTEXT CALIBRATION")
            print("-" * 100)
            print(f"{'INDICES DIR':<20} {payload['indices_dir']}")
    ...
    if args.context_command == "presets":
        ...
        if getattr(args, "json", False):
            ...
            print("AURUM MARKET CONTEXT PRESETS")
            print("-" * 100)
    ...
    if args.context_command == "check":
        ...
        if getattr(args, "json", False):
            ...
            print("AURUM MARKET CONTEXT CHECK")
            print("-" * 100)
