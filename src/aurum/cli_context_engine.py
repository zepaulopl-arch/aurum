...
from aurum.context_engine.renderer import (
    render_context_audit,
    render_context_explain,
    render_context_show,
)
from aurum.context_engine.sources import read_json_file, write_json
...
def build_context_engine_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="aurum context")
