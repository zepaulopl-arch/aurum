...
from aurum import train_detail_report as train_detail_report_mod
...
from aurum.prediction_config import effective_prediction_config, horizon_key
from aurum.prediction_lab import run_prediction_lab
from aurum.ui import color_metric, colorize, muted_line, strip_ansi
...
def _aurum_force_payload_canonical_features(payload):
    ...
    try:
        from aurum.features.training_selector import load_canonical_feature_names
        from aurum.features.groups import is_duplicate_alias
