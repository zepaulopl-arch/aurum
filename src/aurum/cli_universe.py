...
from aurum.ui import color_metric, colorize, format_kv_section, muted_line, short_sector


def _render_universe_check(payload: dict[str, Any]) -> str:
    line = "-" * 100
    lines = [
        "AURUM UNIVERSE CHECK",
        line,
