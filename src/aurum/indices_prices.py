...
from aurum.indices_catalog import read_indices_catalog
...
def _provider_exclusive_end(end: str | None) -> str | None:
...
def fetch_indices_prices(
    *,
    ...
    provider_end = _provider_exclusive_end(end)
    ...
    for item in catalog_payload["indices"]:
        ...
        try:
            ...
            rows = _download_yfinance(symbol, start=fetch_start, end=provider_end)
