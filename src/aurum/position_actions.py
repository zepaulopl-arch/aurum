...
from aurum.borrow_data import borrow_status_for_record, load_borrow_data, load_borrow_policy
from aurum.borrow_rates import normalize_ticker, read_borrow_rates_csv
from aurum.short_execution import ShortExecutionConfig, evaluate_short_execution
from aurum.domain import AssetDecision, DailyReport, ExecutionStatus, MarketRegime
from aurum.explain import decision_codes
from aurum.position_actions_config import load_position_actions_config
from aurum.short_policy import (
    apply_legacy_short_overrides,
    load_short_policy,
    load_short_thresholds,
)
from aurum.terminal_render import muted_line
...
def render_position_books(position_actions: dict[str, Any]) -> list[str]:
    from aurum.short_render import render_position_books as renderer
