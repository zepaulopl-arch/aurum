...
def load_presets(path: str | Path = "config/aurum_presets.json") -> dict[str, Any]:
    file_path = Path(path)
...
def resolve_profile(
    name: str | None = None,
    path: str | Path = "config/aurum_presets.json",
) -> dict[str, Any]:
...
def get_default_paths(path: str | Path = "config/aurum_presets.json") -> dict[str, str]:
