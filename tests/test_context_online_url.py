...
from pymercator.context_engine.inflation import fetch_focus_expectations
...
def test_focus_url_has_no_spaces_when_network_fails_or_succeeds(monkeypatch) -> None:
    ...
    monkeypatch.setattr("pymercator.context_engine.inflation.http_get_json", fake_http_get_json)
